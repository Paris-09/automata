...
export function AutomataSimulator({
    selectedRegex,
    selectedModel,
    handleNavigate,
}: Props) {
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-3 ml-7 mb-10 mt-35 group">
                <h2
                    id="configuration"
                    className="text-2xl font-semibold text-left tracking-wide"
                >
            ...
            <div className="grid grid-cols-[360px_1fr] gap-12 w-full max-w-full bg-white py-4 px-7 pt-1 overflow-x-hidden">
                ...
                <div className="min-w-0">
                    <div className="grid grid-cols-[1.2fr_0.8fr_1fr] gap-4 mb-6">
                        <span className="font-semibold text-md tracking-wider text-center text-gray-400">
                            Enter Strings
                        </span>
                        <span className="font-semibold text-md tracking-wider text-center text-gray-400">
                            Status
                    ...
                    <div className="space-y-5">
                        {rows.map((row) => (
                            <div
                                key={row.id}
                                className="grid grid-cols-[1.2fr_0.8fr_1fr] gap-4 items-center"
                            >
                                <Input
                                ...
                                <Button
                                    ...
                                    disabled={row.input === ""}
                                    onClick={() =>
                                        handleSimulate(row.id, row.input)
                                    }
                ...
                {/* Right Column */}
                <div className="min-w-0">
                    <span className="font-semibold text-md tracking-wider block mb-6 text-left text-gray-400">
                        Transition Diagram
                    </span>
                        ...
                        {selectedModel !== "dfa" ? (
                            <div className="w-full h-full flex items-center justify-center">
                                <p className="text-lg text-black font-normal tracking-tight text-center px-4">
                                    Graph rendering for{" "}
                                    {selectedModel.toUpperCase()} will be
                                    implemented soon...
                                </p>
                            </div>
                        ) : (
