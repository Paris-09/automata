...
export const CircleNode: React.FC<CircleNodeProps> = ({ data }) => {
    const { isAcceptState, isHighlighting, isHighlighted, isValid, isInvalid, label } = data;
    ...
    const classes = [
        ...
        isValid == null ? "" : (isValid ? 'is-valid' : 'is')
    ].join(" ");
