...
const DfaAbEdges: Edge[] = [
    ...
    createEdge("q10-b-q10", "source-bottom-left", "target-right-top"),
    ...
    createEdge("q13-b-q14", "source-right-top"", "target-right-top"),

    createEdge("q11-a-q11", "source-right-top", "target-bottom-mid"),
    createEdge("q11-a-q11", "source-top-left", "target-right-top"),
    createEdge("q11-a-q11", "source-top-left", "target-right-top"),
    createEdge("q11-a-q11", "source-top-left", "target-right-top"),
    createEdge("q11-a-q11", "source-top-left", "target-right-top"),
