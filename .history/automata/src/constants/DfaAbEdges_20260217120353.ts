...
export const DfaAbEdges: Edge[] = [
    ...
    createEdge("q7-a-q7", "source-top-left", "target-right-top", "smoothstep"),
    ...
    createEdge("q10-b-q10", "source-bottom-left", "target-right-bottom", "smoothstep"),

    createEdge("q11-a-q11", "source-top-left", "target-right-top", "smoothstep"),
    createEdge("q11-b-q14", "source-right-mid", "target-top-mid"),

    createEdge("q12-a-q12", "source-top-left", "target-right-top", "smoothstep"),
