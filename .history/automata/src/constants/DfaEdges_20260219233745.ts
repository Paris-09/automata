...
const createEdge = (
    ...
    return {
        ...
        style: { strokeWidth: 2, stroke: '#575656ab', strokeOpacity: 0.5 },
    }
}

export const Dfa01Edges: Edge[] = [
    createEdge("q0-a-q1", "source-top-right", "target-left-bottom"),
    createEdge("q0-b-q3", "source-bottom-right", "target-left-top"),

    createEdge("q1-a-q4", "source-right-bottom", "target-top-left"),
    createEdge("q1-b-q2", "source-bottom-mid", "target-top-mid"),

    createEdge("q2-a-q2", "source-bottom-left", "target-left-bottom"),
    createEdge("q2-b-q2", "source-bottom-right", "target-right-bottom"),

    createEdge("q3-a-q2", "source-top-mid", "target-bottom-mid"),
    createEdge("q3-b-q4", "source-right-top", "target-bottom-left"),

    createEdge("q4-a-q5", "source-right-mid", "target-left-mid"),
    createEdge("q4-b-q4", "source-top-mid", "target-right-top"),

    createEdge("q5-a-q5", "source-top-mid", "target-right-top"),
    createEdge("q5-b-q7", "source-right-mid", "target-left-mid"),

    createEdge("q6-a-q9", "source-bottom-right", "target-left-top"),
    createEdge("q6-b-q11", "source-right-bottom", "target-left-bottom"),

    createEdge("q7-a-q6", "source-top-mid", "target-bottom-mid"),
    createEdge("q7-b-q10", "source-right-mid", "target-left-top"),

    createEdge("q8-a-q5", "source-left-mid", "target-bottom-right"),
    createEdge("q8-b-q7", "source-top-mid", "target-bottom-mid"),

    createEdge("q9-a-q9", "source-bottom-mid", "target-right-bottom"),
    createEdge("q9-b-q11", "source-right-top", "target-bottom-left"),

    createEdge("q10-a-q8", "source-bottom-left", "target-right-top"),
    createEdge("q10-b-q12", "source-bottom-right", "target-left-top"),

    createEdge("q11-a-q6", "source-left-top", "target-right-top"),
    createEdge("q11-b-q12", "source-bottom-mid", "target-top-mid"),

    createEdge("q12-a-q8", "source-left-mid", "target-right-mid"),
    createEdge("q12-b-q12", "source-right-top", "target-bottom-left"),
]
