...
export const Dfa10Edges: Edge[] = [
    createEdge("q0-a-q1", "source-top-mid", "target-left-mid"),
    createEdge("q0-b-q3", "source-bottom-mid", "target-left-mid"),

    createEdge("q1-a-q4", "source-right-mid", "target-top-left"),
    createEdge("q1-b-q2", "source-bottom-mid", "target-top-mid"),

    createEdge("q2-a-q2", "source-left-bottom", "target-top-left"),
    createEdge("q2-b-q2", "source-right-bottom", "target-top-right"),

    createEdge("q3-a-q2", "source-top-mid", "target-bottom-mid"),
    createEdge("q3-b-q4", "source-right-mid", "target-bottom-left"),

    createEdge("q4-a-q7", "source-top-left", "target-left-mid"),
]
