...
const createEdge = (
    ...
    return {
        ...
        target: target,
        label: label,
        labelStyle: { fill: '#ffffff', fontWeight: 1500, fontSize: 15, fontFamily: 'monospace' },
        labelBgStyle: { fill: '#413d3d', fillOpacity: 0.8 }, // Makes a semi-transparent white box
        labelBgPadding: [4, 2], // Adds small padding around the text
        ...
        animated: false,
        markerEnd: { type: MarkerType.ArrowClosed,  color: '#534f51' },
        style: { strokeWidth: 3, stroke: '#423e40', strokeOpacity: 0.5 },
    }
}
