...
export const DfaAbEdges: Edge[] = [
    ...
    createEdge("q7-a-q7", "source-top-right", "target-left-top"),
    ...
    createEdge("q10-b-q10", "source-left-bottom", "target-bottom-mid"),

    createEdge("q11-a-q11", "source-left-top", "target-top-mid"),
