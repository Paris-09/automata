...
export const Dfa01Edges: Edge[] = [
    ...
    createEdge("q6-a-q9", "source-bottom-right", "target-left-mid"),
    createEdge("q6-b-q11", "source-right-mid", "target-left-mid"),

    createEdge("q7-a-q6", "source-top-mid", "target-bottom-mid"),
    createEdge("q7-b-q10", "source-right-mid", "target-left-mid"),
    ...
    createEdge("q9-b-q11", "source-right-mid", "target-bottom-left"),

    createEdge("q10-a-q8", "source-bottom-left", "target-right-bottom"),
    createEdge("q10-b-q12", "source-right-mid", "target-bottom-left"),
]
